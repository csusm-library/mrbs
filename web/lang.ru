...
// $Id: lang.ru 2300 2012-06-21 14:24:16Z cimorrison $
...
$vocab["fulldescription"]    = "Подробное описание:<br>&nbsp;&nbsp;(Количество участников,<br>&nbsp;&nbsp;вид и т.п.)";
$vocab["date"]               = "Дата";
$vocab["start"]              = "Начало";
...
$vocab["is_mandatory_field"] = "это обязательное поле, пожалуйста, введите значение";
...
$vocab["series"]              = "серию";
$vocab["request_more_info"]   = "Пожалуйста, укажите дополнительную информацию";
...
$vocab["no_request_yet"]      = "Запрос еще не был отправлен"; // Used for the title tooltip on More Info button
$vocab["last_request"]        = "Последний запрос отправлен в";         // Used for the title tooltip on More Info button
$vocab["by"]                  = "по";                           // Used for the title tooltip on More Info button
...
$vocab["conflict"]           = "Новое бронирование конфликтует со следующими записями";
$vocab["rules_broken"]       = "Новое бронирование конфликтует со следующими политиками";
$vocab["too_may_entrys"]     = "Выбранные опции создадут слишком много записей.<br>Пожалуйста выберите другие опции!";
...
$vocab["must_set_description"] = "Вы должны ввести краткое описание бронирования. Пожалуйста, вернитесь назад и заполните его.";
$vocab["mail_subject_approved"]  = "Запись утверждена $mrbs_company ";
$vocab["mail_subject_rejected"]  = "Запись отклонена $mrbs_company ";
$vocab["mail_subject_more_info"] = "$mrbs_company : запрошена более подробная информация";
$vocab["mail_subject_reminder"]  = "Напоминание для $mrbs_company ";
$vocab["mail_body_approved"]     = "Запись утверждена администраторами; подробная информация здесь:";
$vocab["mail_body_rej_entry"]    = "Запись отклонена администраторами; подробная информация здесь:";
$vocab["mail_body_more_info"]    = "Администраторам требуется больше информации об этой записи; подробная информация здесь:";
$vocab["mail_body_reminder"]     = "Напоминание - запись ожидает утверждения; подробная информация здесь:";
...
$vocab["mail_body_new_entry"]     = "Внесена новая запись, подробная информация здесь:";
$vocab["mail_body_changed_entry"] = "Запись была изменена, подробная информация здесь:";
$vocab["mail_body_del_entry"]     = "Запись была удалена, подробная информация здесь:";
...
$vocab["upgrade_required"]         = "База данных должна быть обновлена. Пожалуйста, выполните резервное копирование базы данных перед обновлением.";
$vocab["supply_userpass"]          = "Пожалуйста, укажите имя и пароль пользователя базы данных, имеющего права администратора.";
$vocab["contact_admin"]            = "Если у Вас нет прав администрирования, свяжитесь с администратором $mrbs_admin.";
$vocab["upgrade_to_version"]       = "Обновление до версии базы данных";
$vocab["upgrade_to_local_version"] = "Обновление до версии локальной базы данных";
...
$vocab["password_twice"]     = "Если вы хотите изменить пароль, пожалуйста, введите новый пароль дважды";
$vocab["passwords_not_eq"]   = "Пароли не совпадают!";
$vocab["password_invalid"]   = "Пароль не соответствует политике. Он должен содержать по крайней мере:";
...
$vocab["ok"]                 = "ОК";
$vocab["show_my_entries"]    = "Щелкните, чтобы вывести все предстоящие записи";
$vocab["no_users_initial"]   = "Нет пользователей с административными правами";
$vocab["no_users_create_first_admin"] = "Создайте пользователя с административными правами, после этого Вы сможете создать остальных пользователей.";
$vocab["warning_last_admin"] = "Предупреждение!  Это последний  пользователя с административными правами и Вы не можете его удалить или лишить административных прав. Иначе Вы не сможете войти в систему.";
...
$vocab["ctrl_click_type"]       = "Используйте Control-Click чтобы выделить более одного типа";
...
$vocab["report_as_ical"]        = "Отчет как iCalendar (.ics file) - исключая периоды";
...
$vocab["browserlang"]        = "Ваш обозреватель имеет следующий порядок языковых предпочтений";
...
$vocab["update_room_failed"]      = "Обновление описания помещения завершилось неудачно: ";
$vocab["error_room"]              = "Ошибка: помещение ";
$vocab["not_found"]               = " не найдено";
$vocab["update_area_failed"]      = "Обновление описания корпуса завершилось неудачно: ";
...
$vocab["enable_reminders"]        = "Разрешить пользователям создавать напоминания администраторам";
$vocab["private_settings"]        = "Настройки конфиденциальности";
$vocab["allow_private"]           = "Разрешить конфиденциальное бронирование";
$vocab["force_private"]           = "Использовать конфиденциальное бронирование по умолчанию";
$vocab["default_settings"]        = "Настройки по умолчанию";
$vocab["default_private"]         = "Конфиденциальное";
$vocab["default_public"]          = "Общедоступное";
$vocab["private_display"]         = "Настройки конфиденциальности (отображение)";
$vocab["private_display_label"]   = "Как должны отображаться конфиденциальные бронирования?";
$vocab["private_display_caution"] = "ВНИМАНИЕ: Подумайте тщательно о последствиях конфиденциальности , прежде чем изменять эти параметры";
$vocab["treat_respect"]           = "Соблюдать параметры создания конфиденциальности бронирования";
$vocab["treat_private"]           = "Обрабатывать все бронирования как конфиденциальные, игнорируя их параметры создания";
$vocab["treat_public"]            = "Обрабатывать все бронирования как общедоступные, игнорируя их параметры создания";
$vocab["sort_key"]                = "Ключ сортировки";
$vocab["sort_key_note"]           = "Ключ, используемый для бронирования помещений";
...
$vocab["custom_html_note"]        = "Это поле может быть использовано для отображения вашего собственного HTML, например, встроенных карт Google";
$vocab["email_list_note"]         = "Введите список адресов электронной почты, разделенных запятыми или символами новой строки";
$vocab["mode"]                    = "Режим";
...
$vocab["disabled_area_note"]      = "Если корпус отключен, он не появится в календаре " .
                                    "и невозможно забронировать помещения в нем. Однако существующие бронирования " .
                                    "будут сохранены и будут видны в поиске и результатах отчетов.";
$vocab["disabled_room_note"]      = "Если помещение отключено, оно не появится в календаре " .
                                    "и невозможно забронировать помещения в нем. Однако существующие бронирования " .
                                    "будут сохранены и будут видны в поиске и результатах отчетов.";
$vocab["book_ahead_note_periods"] = "При использовании периодов, бронирование округляется до ближайшего целого дня.";

// Used in edit_users.php
$vocab["name_empty"]         = "Вы должны ввести имя.";
$vocab["name_not_unique"]    = "уже существует. Пожалуйста, выберите другое имя.";
...
$vocab["YES"]                = "Да";
$vocab["NO"]                 = "Нет";
$vocab["delarea"]            = "Вы должны удалить все помещения в этом корпусе перед его удалением <p>";
